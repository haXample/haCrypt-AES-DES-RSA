...
;;
;; Listing generated by Microsoft (R) Optimizing Compiler Version 19.28.26336 for x64
;; 
...
; 
        TITLE   C:\Temp600\__\AESfast.asm
;       INCLUDE listing.inc     ; Needed for NPAD Macros (C++ Compiler specific)
...
; Include C libraries
;
;includelib libcmt                          ; MS Visual C++ specific
;includelib oldnames                        ; MS Visual C++ specific
;includelib msvcrtd                         ; MS Visual C++ specific
;includelib legacy_stdio_definitions.lib    ; For _scanf, _printf, ...
;
